...
export interface SearchEngine {
   ...
   * type.
   *
   * @param {string} type - The type or name of the document set for which an
   *   indexer should be retrieved. This corresponds to the `type` property on
   *   the document collator/decorator factories and will most often be used to
